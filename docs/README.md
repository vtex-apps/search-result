...
| ---------------------- | ---------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------- |
| `maxItemsPerPage`      | `Number`         | Maximum number of items per search page. The maximum value of this prop is `50`, if a bigger number is passed, the query will fail.                                                                                                                                                               | `10`                |
