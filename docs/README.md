...
| `queryField` | `string` | Defines a query string for the search custom query. This prop should be used when building a custom search page with a pre-defined URL i.e. pre-defined fetched results. | `undefined` |
| `mapField` | `string` | Defines the query string's map field for the search custom query. This prop should be used when building a custom search page with a pre-defined URL i.e. pre-defined fetched results. |
